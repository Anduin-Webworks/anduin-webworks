      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col-reverse lg:flex-row items-center gap-8 lg:gap-16">
          ...
          <div className="flex-1 flex flex-col gap-8 animate-fade-in">
            ...
            <a
              href="#contact"
              className="self-center lg:self-start inline-flex items-center gap-3 px-8 py-4 rounded-lg font-outfit font-medium text-lg transition-all duration-300 hover:scale-105 hover:shadow-lg"
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-4">
                {socialLinks.map((link) => (
                  <a
                    ...
                    className="flex items-center justify-center gap-3 px-6 py-3 border-2 border-border rounded-lg font-outfit font-medium hover:border-primary hover:text-primary transition-all duration-300 group"
                  >
          ...
          <div className="flex-1 flex justify-center lg:justify-end">
            <img
              ...
              className="w-[60%] lg:w-[80%] animate-float drop-shadow-2xl rounded-2xl"
            />
          </div>
        </div>
      </div>
