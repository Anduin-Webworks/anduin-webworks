      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <button
            ...
            className="lg:hidden flex items-center justify-center w-12 h-12 rounded-full overflow-hidden border-2 border-primary/50 hover:border-primary transition-colors"
          >
            {isMenuOpen ? (
          ...
          {/* Desktop Logo with Site Switcher */}
          <div className="hidden lg:block">
            <SiteSwitcher logoSrc={logoSrc} />
          </div>
          ...
          {/* Theme toggle and subtitle on desktop right side */}
          <div className="hidden lg:flex items-center gap-4">
            <span className="font-outfit text-muted-foreground">Audit Readiness</span>
            <ThemeToggle />
          </div>
          ...
          <div className="lg:hidden flex items-center gap-2">
            <span className="font-cinzel text-sm font-bold text-foreground">
              Anduin <span className="text-primary">Watch</span>
            </span>
            <ThemeToggle />
          </div>
        </div>
